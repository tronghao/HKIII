...
void QuickSort_else(int a[], int left, int right);
void QuickSortChanLe(int a[], int left, int right);
...
do{	
	...
	printf("4.Selection Sort: Tang dan (duyet End-Start)\n");
	printf("5.Insertion Sort: Tang dan (duyet Start-End)\n");
	printf("6.Insertion Sort: Tang dan (duyet End-Start)\n");
	printf("7.Interchage Sort: Tang dan (duyet Start-End)\n");
	printf("8.Interchage Sort: Tang dan (duyet End-Start)\n");
	printf("9.Bubble Sort: Tang dan (duyet Start-End)\n");
	printf("10.Bubble Sort: Tang dan (duyet End-Start)\n");
	printf("11.Quick Sort: Tang dan\n");
	printf("12.Quick Sort: Giam dan\n");
	printf("13.Quick Sort: Chan Le\n");
	printf("14.Heap Sort: Tang dan\n");
	printf("15.Heap Sort: Giam dan\n");
...
{ 	
	...
	QuickSort_else(a, left, j);
	QuickSort_else(a, i, right);
